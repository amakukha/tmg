...
//#define DST_LANGUAGE "octal value"
...
#define __program  (tword)&start[1]
	1 + (tword)&parse,
#define __display  (tword)&labels[1]
	__display,
#undef _2
#define _2         (tword)&start[3]
	(tword)"Octal value of x: ",
#undef _1
...
// __display:
	(tword)&octal,
#define __x        (tword)&labels[3]
	__x,
	1 + (tword)&trans,
	1 + _1,
// __x:
	077,
#define __classtab (tword)&start[14]
	0,
	0,
	0,
	0,
